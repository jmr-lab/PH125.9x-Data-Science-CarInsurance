...
The date of birth ranges from 5 April 1918 to 11 October 2000, indicating that the drivers cover a wide span of ages, with most being born between 1960 and 1980. This suggests that the dataset includes both older and relatively newer drivers, allowing for an analysis of trends across different age groups.

The date of driving license acquisition varies from 1 October 1942 to 26 November 2018, indicating that some drivers have held their licenses for many decades, while others are more recent license holders.
...
The policy IDs range from 1 to 53,502, indicating a substantial dataset of individual insurance policies. The contract start dates span from 25 October 1980, to 30 November 2018, with a mean date around 26 June 2014, suggesting a blend of older and more recent policies. The last renewal dates have a similar range, with the earliest being 2 November 2015, and the latest also being 30 November 2018, implying all policies were active at some point between 2015 and 2018. The Distribution_channel indicates that more policies were contracted through agents (0) than through brokers (1).
...
Notably, the premium in the original dataset appears to be comprehensive, as it is primarily based on vehicle characteristics rather than other variables such as the policyholder's age or claim history. It seems the insurer has a compulsory excess of 50 euros and a voluntary excess of 800 euros that are consistent across all policies, indicating that these excess amounts are independent of specific policy details.
...
Looking ahead, our next steps include further optimizing the code to enhance execution speed and reduce runtime. The offset was selected using an empirical approach, and further refinement of this method is needed to minimize the relative error in the test set. We also plan to explore the integration of Zero-Inflated Models such as Poisson (ZIP) or Negative Binomial (ZINB). By implementing these enhancements to our modelling strategy, we anticipate achieving substantial reductions in prediction errors and improving overall efficiency in our analysis.
