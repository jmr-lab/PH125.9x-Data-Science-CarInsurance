...
> `r fa("file-excel", fill = "forestgreen")` Descriptive of the variables.xlsx

> `r fa("file-csv", fill = "forestgreen")` Motor vehicle insurance data.csv

> `r fa("file-csv", fill = "forestgreen")` sample type claim.csv
...
The last file "sample type claim.csv" contains a list of different claims :
